...
StartupEvents.registry("block", (e) => {
  ...
  e.create("society:ribbit_hut_block_bottom_right_front")
    .box(4, 0, 4, 12, 9, 12)
    .tagBlock("minecraft:mineable/pickaxe")
    .tagBlock("minecraft:needs_stone_tool")
    .defaultCutout()
    .soundType("stone")
    .model("society:block/ribbit_hut/bottom_right_front");
  e.create("society:ribbit_hut_block_bottom_right_middle")
    .box(4, 0, 4, 12, 9, 12)
    .tagBlock("minecraft:mineable/pickaxe")
    .tagBlock("minecraft:needs_stone_tool")
    .defaultCutout()
    .soundType("stone")
    .model("society:block/ribbit_hut/bottom_right_middle");
  e.create("society:ribbit_hut_block_bottom_right_back")
    .box(4, 0, 4, 12, 9, 12)
    .tagBlock("minecraft:mineable/pickaxe")
    .tagBlock("minecraft:needs_stone_tool")
    .defaultCutout()
    .soundType("stone")
    .model("society:block/ribbit_hut/bottom_right_back");
});
