...
global.springOcean = [
  ...
  { fish: "aquaculture:jellyfish", weight: 12, night: true },
...
global.springRiver = [
  { fish: "aquaculture:minnow", weight: 14 },
  { fish: "aquaculture:bluegill", weight: 14 },
  { fish: "aquaculture:bluegill", weight: 14, night: true },
  { fish: "aquaculture:smallmouth_bass", weight: 12 },
  { fish: "aquaculture:smallmouth_bass", weight: 12, night: true },
  { fish: "minecraft:cod", weight: 13 },
  { fish: "minecraft:cod", weight: 13, night: true },
  { fish: "aquaculture:pink_salmon", weight: 12, night: true },
...
global.springFresh = [
  ...
  { fish: "aquaculture:bluegill", weight: 14 },
  { fish: "aquaculture:bluegill", weight: 14, night: true },
  { fish: "aquaculture:perch", weight: 12 },
  { fish: "aquaculture:carp", weight: 12, requiresRain: true },
...
global.summerOcean = [
  ...
  { fish: "aquaculture:goldfish", weight: 1, requiresClear: true },
];
global.summerRiver = [
  { fish: "aquaculture:minnow", weight: 28 },
  { fish: "aquaculture:bluegill", weight: 28 },
...
global.summerFresh = [
  ...
  { fish: "aquaculture:bluegill", weight: 14 },
  { fish: "aquaculture:bluegill", weight: 14, night: true },
  { fish: "aquaculture:carp", weight: 12 },
  { fish: "aquaculture:leech", weight: 12, night: true },
  { fish: "aquaculture:piranha", weight: 12, night: true, requiresRain: true },
...
// Autumn Fish
global.autumnOcean = [
  { fish: "aquaculture:blackfish", weight: 32, night: true },
  {
    fish: "minecraft:pufferfish",
    weight: 24,
    night: true,
  ...
  { fish: "aquaculture:red_shrooma", weight: 1, requiresRain: true },
];
global.autumnRiver = [
  { fish: "aquaculture:minnow", weight: 28 },
  { fish: "aquaculture:bluegill", weight: 28 },
...
// Winter Fish
global.winterOcean = [
  { fish: "aquaculture:atlantic_herring", weight: 28 },
  { fish: "aquaculture:atlantic_herring", weight: 28, night: true },
  ...
  { fish: "aquaculture:brown_shrooma", weight: 1, requiresRain: true },
];
global.winterRiver = [
  { fish: "aquaculture:minnow", weight: 28 },
  { fish: "aquaculture:bluegill", weight: 28 },
...
global.winterFresh = [
  ...
  { fish: "aquaculture:bluegill", weight: 14 },
  { fish: "aquaculture:bluegill", weight: 14, night: true },
  { fish: "aquaculture:perch", night: true, weight: 12 },
